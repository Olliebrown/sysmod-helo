...
import { connectAndAction, downloadFile, ensureFileExists, uploadFile } from './ftpHelper.js'
...
export function downloadLogs () {
  connectAndAction(async (client) => {
    // Download Log files
    await downloadFile(client, path.join('/config', SYSMOD_NAME), 'log.txt', './', 'log.txt')
  })
}
